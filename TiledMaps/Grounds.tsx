...
<tileset version="1.9" tiledversion="1.9.2" name="Grounds" tilewidth="16" tileheight="16" tilecount="30" columns="6">
 <image source="TileArt/grounds_atlas.png" width="96" height="80"/>
 <tile id="20" probability="0.03"/>
 <tile id="21" probability="0.91"/>
 <tile id="26" probability="0.03"/>
 <tile id="27" probability="0.03"/>
 <wangsets>
  <wangset name="Grass_Path_Farm" type="corner" tile="-1">
   <wangcolor name="Path" color="#ff0000" tile="-1" probability="1"/>
   <wangcolor name="Grass" color="#00ff00" tile="-1" probability="1"/>
   <wangcolor name="Farm" color="#0000ff" tile="-1" probability="1"/>
   ...
   <wangtile tileid="28" wangid="0,2,0,3,0,3,0,3"/>
   <wangtile tileid="29" wangid="0,3,0,3,0,3,0,2"/>
  </wangset>
 </wangsets>
</tileset>
